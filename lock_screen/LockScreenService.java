...
public class LockScreenService extends Service {
    ...
    public void updateTime() {
        try {
            ...
            settingPrefManager = new SettingPrefManager(this);
            ...
            //Toast.makeText(getApplicationContext(), "Lock Screen " + settingPrefManager.getSetting().getTimeZoneGMT() + " : " + tz.getDisplayName(false, TimeZone.SHORT), Toast.LENGTH_SHORT).show();

          ...
          /*      case EVENT_LANGUAGE_CODE:
                ...
                case EVENT_SILENT_MODE_CODE:
                    ...
                    if (silentDao != null && !silentDao.getSilentMode().isEmpty()) {
                        Timber.e("Silent : " + silentDao.getSilentMode());
                ...
                case EVENT_TIMEZONE_CODE:
                    ...
                    if (timeZoneDao != null && !timeZoneDao.getAutoTimezone().isEmpty() && !timeZoneDao.getTimeZone().isEmpty()) {
                        Timber.e("Timezone : " + timeZoneDao.getAutoTimezone());
                        Toast.makeText(AppContextor.getInstance().getContext(),"Timezone Receive : "+timeZoneDao.getAutoTimezone()+" :: "+timeZoneDao.getTimeZoneGMT(),Toast.LENGTH_SHORT).show();
                        SettingPrefModel settingPrefModel = iSettingManager.getSetting();
                        settingPrefModel.setTimeZone(timeZoneDao.getTimeZone());
                        settingPrefModel.setTimeZoneGMT(timeZoneDao.getTimeZoneGMT());
                        ...
                        else view.setUpTimeZone(timeZoneDao.getTimeZoneGMT());
                    }
                    break;

    ...
    public void onInitialSuccess(MetaDataNetwork metaData, DeviceInfoModel data) {
        try {
            ...
            if (settingManager != null && data.getDeviceSetUp() != null) {
                ...
                setting.setTimeZoneGMT(deviceSetUp.getTimeZoneGMT());
